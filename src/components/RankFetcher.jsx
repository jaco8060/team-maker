  ...
  const getPlayerRank = async () => {
    try {
      ...
      const accountResponse = await fetch(
        `https://team-maker-api.vercel.app/team-maker/riot/account/v1/accounts/by-riot-id/${riotId}/${tagLine}?api_key=${apiKey}`
      );
      ...
      const summonerResponse = await fetch(
        `https://team-maker-api.vercel.app/team-maker/lol/summoner/v4/summoners/by-puuid/${encryptedPUUID}?api_key=${apiKey}`
      );
      ...
      const rankResponse = await fetch(
        `https://team-maker-api.vercel.app/team-maker/lol/league/v4/entries/by-summoner/${encryptedSummonerId}?api_key=${apiKey}`
      );
